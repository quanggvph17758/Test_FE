...
@Component({
  selector: 'app-your-oder-detail',
  templateUrl: './your-oder-detail.component.html',
  styleUrls: ['./your-oder-detail.component.css']
})
export class YourOderDetailComponent implements OnInit {
